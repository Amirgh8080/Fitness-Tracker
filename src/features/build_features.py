...
subset = df_squared[df_squared["set"] == 47]
...
for k in x_values:
    ...
    kmean = KMeans(n_clusters=k, n_init=20, random_state=0)
    cluster_labels = kmean.fit_predict(subset)
    inertias.append(kmean.inertia_)

plt.figure(figsize=(10, 10))
plt.plot(x_values, inertias)
plt.show()
